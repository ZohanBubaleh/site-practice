      ...
      <div class="header">     
        ...
        <div class="about_me">
          <h1><?php  echo $p  ?></h1>
            <div class="data">
               <div class="myImg">
                    <?php  echo '<img src="/img/Avatar-Glaza.jpg" alt="Сладкий Буболех - это Вам не фунт изюма" title="Сладкий Буболех - это Вам не фунт изюма" width=400" height="400">'; ?>                    
               </div>
                  <div class="fullname">
                    <p> Меня зовут 
                    ...
                    <?php  echo $age;   ?>          
                    года </p>
                    <p> Мы вместе учились создавать переменные </p>
                    <p> Научились проводить простые операции с ними </p>
                </div>
            </div>
