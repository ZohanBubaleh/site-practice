...
<body>
    <div class="flex-container">
      <div class="header">     
        ...
        <div class="about_me">
          <h1><?php  echo $p  ?></h1><br>
          <p>Зохан таки не стал изобретать велосипед, ему понятно, из чего состоит сайт, как это работает и почему именно так, а не иначе. 
             Зохан закарапузил тут все так, как ему хотелось, патамушта Зохан знает как это делать. А сколько времени сэкономленно?</p>
            <div class="data">
               <div class="myImg">
